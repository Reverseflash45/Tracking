            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //
                  // Cabang ini menampung 14 halaman, sementara empat tab lain
                  // menampung 6, 6, 4, dan 1. Bar bawah bilang kelimanya
                  // setara; isinya bilang yang satu ini jauh lebih berat. Itu
                  // tidak apa-apa — asal begitu masuk, isinya tidak
                  // ditumpahkan sekaligus sebagai sebelas ubin seragam.
                  //
                  // "Nutrisi" dan "Tidur" dulu berdiri sederet dengan "Lari"
                  // dan "Muscle Builder", warnanya sama, ukurannya sama. Tidak
                  // ada yang memberi tahu bahwa dua yang pertama diisi tiap
                  // hari dan dua yang terakhir dibuka sesekali.
                  const SectionHeader(
                    title: 'Latihan',
...
/// Jumlah catatan jadi keterangan baris, bukan kartu tersendiri. Angkanya
/// berguna untuk tahu sudah ada isinya atau belum, tapi tidak cukup penting
/// untuk memakan satu blok utuh di layar.
